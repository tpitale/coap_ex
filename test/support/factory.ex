defmodule CoAP.Test.Support.Factory do
  ...
  def options do
    gen all(
          options <- map_of(integer(0..65535), string(:ascii, max_length: 12 * 8), max_length: 16)
        ) do
      options
    end
  end
